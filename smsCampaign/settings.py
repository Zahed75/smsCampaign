...
WSGI_APPLICATION = 'smsCampaign.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Best Electronics SMS Campaign Solution by-Zahed Hasan',
    'DESCRIPTION': 'SMS Campaign Solution',
